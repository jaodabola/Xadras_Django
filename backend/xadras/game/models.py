...
class Move(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['game', 'move_number']),  # Fast game move retrieval
            models.Index(fields=['game', 'created_at']),   # Chronological queries
            models.Index(fields=['created_at']),           # Recent moves across all games
        ]
        unique_together = ['game', 'move_number']  # Prevent duplicate move numbers
